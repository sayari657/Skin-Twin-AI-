"""
Script pour ajouter TOUS les produits Amazon basés sur les données fournies
"""
...
def add_complete_amazon_products():
    """Ajoute TOUS les produits Amazon basés sur les données fournies"""
    ...
    products_data = [
        ...
        # PRODUITS POPULAIRES - JUSQU'À 10 EUR
        {
    ...
    print("Ajout de TOUS les produits Amazon soins du visage...")
    print("=" * 60)
